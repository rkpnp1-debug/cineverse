        ...
        <form onSubmit={onSearch} className="hidden sm:flex flex-1 max-w-md mx-4">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full rounded-full border border-white/10 bg-surface-800 py-2 pl-10 pr-4 text-sm text-white placeholder:text-zinc-500 focus:border-cinema-500 focus:outline-none focus:ring-1 focus:ring-cinema-500"
            />
          </div>
        </form>
        <button
          ...
          <form onSubmit={onSearch} className="mb-3">
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => setQ(e.target.value)}
                placeholder="Search..."
                className="w-full rounded-full border border-white/10 bg-surface-800 py-2.5 pl-10 pr-4 text-sm"
              />
            </div>
          </form>
          {links.map(({ href, label }) => (
